...
function trocarTamanho() {
    ...
    tamamhoSelecionado = idOpcaoSelecionada.charAt(0);
    tituloProduto.innerText = "Pulseira loop esportiva "+ opcoesCores[corSelecionada].nome +" para caixa de " + opcoesTamanho[tamamhoSelecionado];
    if(opcoesTamanho[tamamhoSelecionado] === '41mm'){
